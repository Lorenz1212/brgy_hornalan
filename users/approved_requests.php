...
<div class="content-wrapper">
    ...
    <div class="table-wrapper">
        <table class="custom-table" id="approvedRequestsTable">
            <thead>
                <tr>
                    <th>Request Type</th>
                    <th>Document Type</th>
                    ...
                    <th>Years Stayed</th>
                    <th>Purpose</th>
                    <th>Date & Time Approved</th> <!-- ✅ Updated Column -->
                    <th>Amount</th>
                    <th>Contact</th>
                    <th>Status</th>
                </tr>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php echo date("F d, Y h:i A", strtotime($row['time'])); ?></td> <!-- ✅ Date & Time -->
...
$(document).ready(function() {
    let table = $('#approvedRequestsTable').DataTable({
        "paging": true,
        "pageLength": 10,
        "lengthChange": false,
        "ordering": true,
