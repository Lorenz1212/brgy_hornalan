...
<div class="form-container">
    ...
    <div class="button-container">
        <a href="../users/edit_cert.php?id=<?php echo $row['id']; ?>" class="btn">Edit</a>
...
function showPaymentNotice() {
    Swal.fire({
        ...
        backdrop: 'none', // Para hindi madilim ang sidebar
        customClass: {
...
function showLoadingSpinner() {
    ...
    setTimeout(() => {
        window.location.href = "../users/done_cert.php?id=<?php echo $clearanceID; ?>";
    }, 2000);
}
