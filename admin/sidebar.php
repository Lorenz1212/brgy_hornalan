...
<div class="navbar">
    ...
    <div class="dropdown-content notif-dropdown" id="requestDropdown">
        <a href="clear_request.php">
            <i class="fa fa-file"></i> Clearance Request
        ...
        <a href="cert_request.php">
            <i class="fa fa-file"></i> Certificate Request
        ...
        <button class="dropbtn" id="userProfileBtn">
            ...
            <i class="fas fa-caret-down"></i> Admin
        </button>
...
<div class="sidebar">
    ...
    <p>Hello, <strong><?php echo isset($_SESSION['username']) ? $_SESSION['username'] : 'User'; ?></strong></p>  <!-- Display username here -->
        <ul>
            <li><a href="admin_dashboard.php" class="nav-link <?php echo ($current_page == 'admin_dashboard.php') ? 'active' : ''; ?>">
            ...
            <li><a href="resident_list.php" class="<?php echo ($current_page == 'resident_list.php') ? 'active' : ''; ?>">
            ...
            <li><a href="recycle.php" class="<?php echo ($current_page == 'recycle.php') ? 'active' : ''; ?>">
